...
import 'package:itda/schoolMealFirst.dart';
import 'package:itda/schoolMeal_edit.dart';
import 'package:image_picker/image_picker.dart';
import 'package:firebase_storage/firebase_storage.dart';
import 'package:flutter/rendering.dart';
import 'package:itda/schoolMealSecond.dart';
              ...
              Padding(
                ...
                child: Container(
                  ...
                  Container(child: Image.asset('assets/add_photo.png'),)
                    ...
                    onTap: () {
                      Navigator.push(context, MaterialPageRoute(builder: (context) => SchoolMealFirst()));
                    },
                  )
                ),
              ),
              ...
              Padding(
                ...
                child: Container(
                  ...
                  Container(child: Image.asset('assets/add_photo.png'),)
                    ...
                    onTap: () {
                      Navigator.push(context, MaterialPageRoute(builder: (context) => SchoolMealSecond()));
                    },
                  )
                ),
              ),
